...
mod tests {
    ...
    #[test]
    fn test_add_entry_with_override_success() {
        let mut vmmap = Vmmap::new();
        
        let result = vmmap.add_entry_with_override(
            100, // page_num
            10,  // npages
            PROT_READ | PROT_WRITE, // prot
            PROT_READ | PROT_WRITE, // maxprot
            0,   // flags
            MemoryBackingType::None,
            0,   // file_offset
            0,   // file_size
    ...
    #[test]
    fn test_add_entry_with_override_zero_pages() {
        let mut vmmap = Vmmap::new();
        ...
        assert_eq!(vmmap.entries.len(), 0);
    }

    #[test]
    fn test_add_entry_with_override_overlapping() {
        let mut vmmap = Vmmap::new();
        
        // Add initial entry
        vmmap.add_entry_with_override(100, 10, PROT_READ, PROT_READ, 0, MemoryBackingType::None, 0, 0, 0).unwrap();
        
        // Add overlapping entry
        let result = vmmap.add_entry_with_override(
            105, // overlaps with existing entry
            10,
            PROT_WRITE,
            PROT_WRITE,
            0,
        ...
        assert!(result.is_ok()); // Should succeed as it's an override
    ...
    #[test]
    fn test_add_entry_with_override_adjacent() {
        let mut vmmap = Vmmap::new();
        ...
        // Add adjacent entry
        let result = vmmap.add_entry_with_override(
            110, // adjacent to existing entry
            10,
            PROT_WRITE,
            PROT_WRITE,
            0,
        ...
        let entry1 = vmmap.find_page(100).unwrap();
        let entry2 = vmmap.find_page(110).unwrap();
